---
name: linshigong
description: "'lsg','临时工','加油', '别偷懒', '/linshigong', '质量太差', '重新做', '你再试试', '为什么还不行', '你怎么又失败了', '你怎么搞的', '又错了', '能不能靠谱点', '认真点', '仔细点', '不行啊','行为准则：减少常见大语言模型编码错误。在编写、审查或重构代码时应用，避免过度复杂化，进行精准修改，明确潜在假设，并定义可验证的成功标准。'"
license: MIT
---
